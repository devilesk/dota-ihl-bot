 ...
 * @type {Object}
 * @property {Guild} guild - The discord guild the lobby belongs to.
 * @property {Category} category - The discord inhouse category.
 * @property {Channel} channel - The discord lobby channel.
 * @property {Role} role - The discord lobby role.
...
const killLobby = async (lobbyState) => {
...
const LobbyStateHandlers = {
    ...
    [CONSTANTS.STATE_CHECKING_READY]: async (_lobbyState) => {
        ...
        if (!playersNotReady.length) {
            ...
            events.push(CONSTANTS.EVENT_LOBBY_KILLED);
