...
const {
    findOrCreateChannelInCategory, findOrCreateRole, addRoleToUser, resolveUser, getUserRoles,
} = require('./guild');
const {
...
const playerToCaptainPriority = guild => captain_role_regexp => async player => [player, getCaptainPriorityFromRoles(captain_role_regexp, await getUserRoles(guild, player))];
