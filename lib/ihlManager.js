...
class IHLManager extends events.EventEmitter {
    ...
    async createNewLeague(guild) {
        this.inhouseStates = await createNewLeague(this)(this.inhouseStates)(guild);
    }
    ...
    async createChallengeLobbyForInhouse(_inhouseState, challenge, giver, receiver) {
        const inhouseState = await createChallengeLobbyForInhouse({ resolveUser, findOrCreateChannelInCategory, makeRole })({ inhouseState: _inhouseState, challenge, eventEmitter: this, captain_1: giver, captain_2: receiver });
