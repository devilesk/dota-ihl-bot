...
const loadQueue = ({ findOrCreateChannelInCategory, getLobbyRole }) => ({
    guild,
    category,
    ready_check_timeout,
    ...
    logger.debug('lobbyState fetched');
    const queueState = {
        guild,
        enabled,
        queue_type,
