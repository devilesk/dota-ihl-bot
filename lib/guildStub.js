...
module.exports = {
    ...
    findOrCreateChannelInCategory: async (guild, category, channelName) => ({ id: channelName, name: channelName, type: 'text', parentID: category.name }),
    ...
    resolveRole: async (guild, roleResolvable) => roleResolvable,
